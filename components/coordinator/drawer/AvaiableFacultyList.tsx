...
import { InviteConfirmationModal } from '@/components/coordinator/modal/InviteConfirmationModal'
import { InviteCancelationModal } from '@/components/coordinator/modal/InviteCancelationModal'
...
export function AvailableFacultyList({
  ...
  const handleInvite = async (facultyId: number) => {
    ...
    const result = await sendInvitation(facultyId, 'COORDINATOR')
