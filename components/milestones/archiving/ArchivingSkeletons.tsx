...
export function ChairReviewSkeleton() {
  ...
  const GRID_COLS = 'grid-cols-[1.2fr_1fr_1.8fr_1.4fr_0.9fr_0.7fr_110px]'
        ...
        <div className="min-w-[960px] flex flex-col min-h-full">
          ...
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className={`grid ${GRID_COLS} items-center px-[20px] h-[60px] border-b border-[#f0f2fa] last:border-b-0`}>
              ...
              <div className="pr-4">
                <div className="h-[13px] w-[90px] rounded bg-[#e8ebf8]" />
              </div>
              <div className="pr-4">
                <div className="h-[12px] w-[140px] rounded bg-[#e8ebf8]" />
              </div>
              <div className="pr-4">
                <div className="h-[12px] w-[120px] rounded bg-[#e8ebf8]" />
              </div>
              <div className="pr-4">
